...
export async function apiRead(userId: string, authHeader?: string): Promise<AxiosResponse<User>> {
...
export async function apiWrite(data: RequestEvent, authHeader?: string): Promise<AxiosResponse<string>> {
